...
const MAX_BODY_BYTES = 20 * 1024 * 1024; // 20MB — supports base64-encoded document uploads
...
function isValidProperty(input: PropertyCreateInput) {
  return (
...
function computeVoteApproval(yes: number, no: number, abstain: number, rule: string): boolean {
...
function isValidAssemblyConfig(input: AssemblyConfigInput) {
  const validBase =
...
function isValidAgendaItem(input: AgendaItemInput) {
  return (
    input.title.trim().length >= 5 &&
...
function isValidAssemblyDocument(input: AssemblyDocumentInput) {
  return (
...
function isValidInvitationDelivery(input: AssemblyInvitationDeliverySummary) {
  return (
...
function isValidAssemblyAccessConfig(input: AssemblyAccessConfigInput) {
  const validBase =
...
function isValidAssemblyAccessGrant(input: AssemblyAccessGrantInput) {
  return (
    input.unitId.trim().length >= 1 &&
...
function isValidOwner(input: OwnerCreateInput) {
...
function getOwnerValidationError(input: UnitOwnerInput, index: number) {
...
function isValidUnit(input: UnitCreateInput) {
  return (
...
function getUnitValidationError(input: UnitCreateInput) {
...
function validateDocumentByType(type: string, value: string) {
